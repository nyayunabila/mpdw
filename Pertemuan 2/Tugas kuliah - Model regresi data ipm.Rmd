...
Pertama-tama akan dicari di mana kira-kira ρ yang menghasilkan SSE minimum. Pada hasil di atas terlihat ρminimum ketika 0.4. Namun, hasil tersebut masih kurang teliti sehingga akan dicari kembali ρ yang lebih optimum dengan ketelitian yang lebih. Jika sebelumnya jarak antar ρ yang dicari adalah 0.2, kali ini jarak antar ρ adalah 0.001 dan dilakukan pada selang 0.2 sampai dengan 0.5.
...
-   Data **IPM di Semarang tahun 2015–2024** menunjukkan adanya autokorelasi pada model awal.  

-   Berdasarkan hasil analisis, dapat diketahui bahwa penanganan autokorelasi dengan metode **Cochrane-Orcutt** menghasilkan nilai **SSE = 1.5934281**, jika dibandingkan dengan nilai SSE model awal, memang nilai SSE **Cochrane-Orcutt** lebih besar, namun DW Statistiknya lebih mendekati 2.

-   Hasil metode **Hildreth-Lu** menghasilkan **SSE 0.3759558** di mana nilai ini lebih kecil dari pada nilai SSE Model Awal dan nilai DW pada metode **Hildreth-Lu** mendekati 2.

Dengan demikian, kedua metode mampu memperbaiki masalah autokorelasi pada data IPM Riau, dan hasilnya jauh lebih baik dibandingkan model awal. Akan tetapi karena nilai SSE Orcutt lebih pada model awal, maka metode **Hildreth-Lu** lebih baik dalam menangani autokorelasi pada data ini.
